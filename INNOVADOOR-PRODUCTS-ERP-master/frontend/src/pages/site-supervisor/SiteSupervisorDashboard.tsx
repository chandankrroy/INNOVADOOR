...
interface SiteDashboardStats {
  active_sites: number;
  doors_pending_fixing: number;
  frames_pending_fixing: number;
  site_issues_open: number;
  pending_photo_updates: number;
}
...
export default function SiteSupervisorDashboard() {
  ...
  const [stats, setStats] = useState<SiteDashboardStats>({
    active_sites: 0,
    doors_pending_fixing: 0,
    frames_pending_fixing: 0,
    site_issues_open: 0,
    pending_photo_updates: 0,
  });
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        setLoading(true);
        const dashboardStats = await api.get('/site-supervisor/dashboard/stats');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
              ...
              <div className="p-6 relative">
                ...
                <div>
                  ...
                  {loading ? (
                    ...
                    <p className="text-3xl font-bold text-gray-900">{stats.active_sites}</p>
                  )}
                </div>
                <Link 
                  to="/site-supervisor/sites" 
            ...
            <div className="group bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden relative">
              ...
              <div className="p-6 relative">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-600 mb-1">Doors Pending</p>
                  {loading ? (
                    <div className="h-8 w-20 bg-gray-200 animate-pulse rounded"></div>
                  ) : (
                    <p className="text-3xl font-bold text-gray-900">{stats.doors_pending_fixing}</p>
                  )}
                </div>
                <Link 
                  to="/site-supervisor/door-fixing" 
            ...
            <div className="group bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden relative">
              ...
              <div className="p-6 relative">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-600 mb-1">Frames Pending</p>
                  {loading ? (
                    <div className="h-8 w-20 bg-gray-200 animate-pulse rounded"></div>
                  ) : (
                    <p className="text-3xl font-bold text-gray-900">{stats.frames_pending_fixing}</p>
                  )}
                </div>
                <Link 
                  to="/site-supervisor/frame-fixing" 
              ...
              <div className="p-6 relative">
                ...
                <div>
                  ...
                  {loading ? (
                    ...
                    <p className="text-3xl font-bold text-gray-900">{stats.site_issues_open}</p>
                  )}
                </div>
                <Link 
                  to="/site-supervisor/issues" 
            ...
            <div className="group bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden relative">
              ...
              <div className="p-6 relative">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-600 mb-1">Pending Photos</p>
                  {loading ? (
                    <div className="h-8 w-20 bg-gray-200 animate-pulse rounded"></div>
                  ) : (
                    <p className="text-3xl font-bold text-gray-900">{stats.pending_photo_updates}</p>
                  )}
                </div>
                <Link 
                  to="/site-supervisor/photos" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    <p className="font-semibold text-gray-900 mb-1">Flat Register</p>
                    <p className="text-sm text-gray-500">View flat-wise door & frame register</p>
                ...
                <Link
                  to="/site-supervisor/daily-progress/create"
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    <p className="font-semibold text-gray-900 mb-1">Daily Progress</p>
                    <p className="text-sm text-gray-500">Create daily site progress report</p>
                ...
                <Link
                  to="/site-supervisor/issues"
                  className="group relative p-6 border-2 border-dashed border-gray-300 rounded-xl hover:border-red-500 hover:bg-gradient-to-br hover:from-red-50 hover:to-red-100/50 transition-all duration-300 text-center block transform hover:scale-[1.02] hover:shadow-lg"
                >
                  <div className="flex flex-col items-center">
                    <div className="p-4 bg-red-100 rounded-xl mb-3 group-hover:bg-red-200 transition-colors">
                      <AlertTriangle className="w-8 h-8 text-red-600" />
                    </div>
                    <p className="font-semibold text-gray-900 mb-1">Report Issue</p>
                    <p className="text-sm text-gray-500">Report site issues & constraints</p>
