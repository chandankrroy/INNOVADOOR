...
export default function RawMaterialSidebar() {
  ...
  // Only show raw material checker menu for raw_material_checker role
  if (currentUser?.role !== 'raw_material_checker') {
    return null;
  }

  const menuItems = [
    { path: '/raw-material/dashboard', label: 'Dashboard', icon: LayoutDashboard },
    { path: '/raw-material/analytics', label: 'Analytics', icon: BarChart3 },
    { path: '/raw-material/calendar', label: 'Calendar', icon: Calendar },
    { path: '/raw-material/parties', label: 'View Party', icon: Users },
    { path: '/raw-material/production-papers', label: 'View Production Papers', icon: FileText },
    { 
      path: '/raw-material/checks', 
      label: 'Raw Material Orders', 
      icon: Package,
      submenu: [
        { path: '/raw-material/checks/pending', label: 'Pending Orders' },
        { path: '/raw-material/checks/issued', label: 'Order Issued' },
        { path: '/raw-material/checks/progress', label: 'Order In Progress' },
        { path: '/raw-material/checks/received', label: 'Order Received' },
      ]
    },
    { path: '/raw-material/orders', label: 'Order to Supplier', icon: ShoppingCart },
    { path: '/raw-material/orders/completed', label: 'Completed Orders', icon: Truck },
    { path: '/raw-material/suppliers', label: 'Supplier Details', icon: Building2 },
    { path: '/raw-material/categories', label: 'Raw Material Categories', icon: Package },
