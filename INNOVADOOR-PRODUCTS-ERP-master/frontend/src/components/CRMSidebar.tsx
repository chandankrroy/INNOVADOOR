...
export default function CRMSidebar() {
  ...
  // Only show CRM menu for crm_manager role
  if (currentUser?.role !== 'crm_manager') {
    return null;
  }

  const menuItems = [
    { path: '/crm/dashboard', label: 'CRM Dashboard', icon: LayoutDashboard },
    { path: '/crm/order-360', label: 'Order 360° View', icon: Eye },
    { path: '/crm/manufacturing-tracker', label: 'Manufacturing Stage Tracker', icon: Factory },
    { path: '/crm/employee-performance', label: 'Employee & Supervisor Performance', icon: Users },
    { path: '/crm/delivery-planner', label: 'Delivery Commitment Planner', icon: Calendar },
    { path: '/crm/delay-monitor', label: 'Delay & Issue Monitor', icon: AlertTriangle },
    { path: '/crm/communication', label: 'Communication & Updates', icon: MessageSquare },
    { path: '/crm/reports', label: 'Reports & Analytics', icon: BarChart3 },
