...
export default function DispatchSidebar() {
  ...
  // Only show dispatch menu for dispatch roles
  ...
  const menuItems = [
    ...
    { path: '/dispatch/history', label: 'Dispatch History', icon: History },
    { 
    ...
    { path: '/dispatch/reports', label: 'Dispatch Reports', icon: BarChart3 },
