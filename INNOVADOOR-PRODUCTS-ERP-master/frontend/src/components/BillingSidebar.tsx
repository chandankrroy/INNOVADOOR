...
export default function BillingSidebar() {
  ...
  // Only show billing menu for billing roles
  ...
  const menuItems = [
    ...
    { 
      ...
      label: 'Dispatch Billing Requests', 
      icon: FileText,
    },
    { 
      path: '/billing/dc', 
      ...
      icon: Package,
      submenu: [
        { path: '/billing/dc/create', label: 'Create DC' },
        { path: '/billing/dc', label: 'View DCs' },
      ]
    },
    { 
      ...
      icon: Receipt,
      submenu: [
        { path: '/billing/invoice/create', label: 'Create Invoice' },
        { path: '/billing/invoice', label: 'View Invoices' },
      ]
    },
    { path: '/billing/history', label: 'Billing History', icon: History },
    { path: '/billing/tally', label: 'Tally Integration', icon: RefreshCw },
    { path: '/billing/credit', label: 'Credit & Payment', icon: CreditCard },
    { path: '/billing/reports', label: 'Reports', icon: FileText },
