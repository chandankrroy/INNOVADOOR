...
export default function LogisticsNavbar() {
  ...
  return (
    <>
      {/* Dark Green Top Bar */}
      <div className="fixed top-0 left-0 right-0 h-1 bg-green-700 z-50"></div>
      
      {/* Main Navbar */}
      <nav 
        className="fixed top-1 left-0 right-0 bg-white shadow-sm border-b border-gray-200 z-40"
      >
