...
export default function PurchaseSidebar() {
  ...
  // Only show purchase menu for purchase roles
  const purchaseRoles = ['purchase_executive', 'purchase_manager', 'store_incharge', 'admin'];
  if (!currentUser || !purchaseRoles.includes(currentUser.role)) {
    return null;
  }

  const menuItems = [
    { path: '/purchase/dashboard', label: 'Purchase Dashboard', icon: LayoutDashboard },
    { 
      path: '/purchase/pr', 
      label: 'Material Requirement (PR)', 
      icon: FileText,
      submenu: [
        { path: '/purchase/pr/create', label: 'Create PR' },
        { path: '/purchase/pr', label: 'View PRs' },
        { path: '/purchase/pr/pending', label: 'Pending Approval' },
      ]
    },
    { 
      ...
      icon: Users,
      submenu: [
        { path: '/purchase/vendors/create', label: 'Create Vendor' },
        { path: '/purchase/vendors', label: 'View Vendors' },
      ]
    },
    { 
      path: '/purchase/po', 
      ...
      icon: ShoppingCart,
      submenu: [
        { path: '/purchase/po/create', label: 'Create PO' },
        { path: '/purchase/po', label: 'View POs' },
        { path: '/purchase/po/pending', label: 'Pending & Open POs' },
      ]
    },
    { 
      path: '/purchase/grn', 
      ...
      icon: Package,
      submenu: [
        { path: '/purchase/grn/create', label: 'Create GRN' },
        { path: '/purchase/grn', label: 'View GRNs' },
      ]
    },
    { 
      ...
      icon: ArrowLeftRight,
      submenu: [
        { path: '/purchase/returns/create', label: 'Create Return' },
        { path: '/purchase/returns', label: 'View Returns' },
      ]
    },
    { 
      path: '/purchase/bills', 
      ...
      icon: Receipt,
      submenu: [
        { path: '/purchase/bills/create', label: 'Create Bill' },
        { path: '/purchase/bills', label: 'View Bills' },
        { path: '/purchase/bills/pending', label: 'Pending Payment' },
      ]
    },
    { path: '/purchase/reports', label: 'Purchase Reports', icon: FileCheck },
    { path: '/purchase/profile', label: 'Profile', icon: UserIcon },
  ];
