...
export default function QualityCheckSidebar() {
  ...
  // Only show quality checker menu for quality_checker role
  if (currentUser?.role !== 'quality_checker') {
    return null;
  }

  const menuItems = [
    { path: '/quality-check/dashboard', label: 'QC Dashboard', icon: LayoutDashboard },
    { path: '/quality-check/pending', label: 'Pending Quality Check', icon: Clock },
    { path: '/quality-check/perform', label: 'Perform Quality Check', icon: ClipboardCheck },
    { path: '/quality-check/history', label: 'QC History', icon: FileText },
    { path: '/quality-check/rework', label: 'Rework / Rejection', icon: RotateCcw },
    { path: '/quality-check/reports', label: 'QC Reports', icon: BarChart3 },
    { path: '/quality-check/certificates', label: 'QC Certificates', icon: CheckCircle2 },
