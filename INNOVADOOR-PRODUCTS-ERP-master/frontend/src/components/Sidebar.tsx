...
export default function Sidebar() {
  ...
  // Only show production menu for production_manager role
  ...
  const menuItems = [
    ...
    { 
      ...
      submenu: [
        ...
        { path: '/products', label: 'View Product' },
        { path: '/designs/create', label: 'Create Design' },
        { path: '/designs', label: 'View Design' },
      ]
    },
    { 
      path: '/measurements', 
      ...
      icon: Ruler,
      submenu: [
        { path: '/measurements/create', label: 'Create Measurements' },
        { path: '/measurements', label: 'View Measurements' },
        { path: '/pending-measurements', label: 'Pending Approvals' },
      ]
    },
    { 
      path: '/parties', 
      ...
      icon: Users,
      submenu: [
        { path: '/parties/create', label: 'Create Parties' },
        { path: '/parties', label: 'View Parties' },
      ]
    },
    { 
      path: '/production-papers', 
      label: 'Production Paper', 
      icon: FileText,
      submenu: [
        { path: '/production-papers/create', label: 'Create Production Paper' },
        { path: '/production-papers', label: 'Production Papers' },
      ]
    },
  ...
  return (
    <div 
      className={`fixed left-0 bg-gray-900 text-white shadow-lg transition-all duration-300 ease-in-out z-50 rounded-r-2xl print-hidden ${
