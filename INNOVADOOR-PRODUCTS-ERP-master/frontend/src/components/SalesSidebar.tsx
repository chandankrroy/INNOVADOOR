...
export default function SalesSidebar() {
  ...
  // Only show sales menu for sales roles
  ...
  const menuItems = [
    ...
    { 
      ...
      icon: UserPlus,
      submenu: [
        { path: '/sales/leads', label: 'View Leads' },
        { path: '/sales/leads/create', label: 'Create Lead' },
      ]
    },
    { 
      path: '/sales/customers', 
      label: 'Customer / Party Master', 
      icon: Users,
      submenu: [
        { path: '/sales/customers', label: 'View Customers' },
        { path: '/sales/customers/create', label: 'Create Customer' },
      ]
    },
    { 
      path: '/sales/sites', 
      ...
      icon: MapPin,
      submenu: [
        { path: '/sales/sites', label: 'View Sites' },
        { path: '/sales/sites/create', label: 'Create Site' },
      ]
    },
    { 
      ...
      icon: FileText,
      submenu: [
        { path: '/sales/quotations', label: 'View Quotations' },
        { path: '/sales/quotations/create', label: 'Create Quotation' },
      ]
    },
    { 
      path: '/sales/orders', 
      ...
      icon: ShoppingCart,
      submenu: [
        { path: '/sales/orders', label: 'View Orders' },
        { path: '/sales/orders/create', label: 'Create Order' },
      ]
    },
    { 
      path: '/sales/measurement-requests', 
      label: 'Measurement Request', 
      icon: Ruler,
      submenu: [
        { path: '/sales/measurement-requests', label: 'View Requests' },
      ]
    },
    { 
      path: '/sales/follow-ups', 
      label: 'Follow-ups & Communication', 
      icon: MessageSquare,
      submenu: [
        { path: '/sales/follow-ups', label: 'View Follow-ups' },
        { path: '/sales/follow-ups/create', label: 'Create Follow-up' },
      ]
    },
    { 
      path: '/sales/reports', 
