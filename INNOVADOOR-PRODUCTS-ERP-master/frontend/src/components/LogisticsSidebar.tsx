...
export default function LogisticsSidebar() {
  ...
  // Only show logistics menu for logistics roles
  ...
  const menuItems = [
    { path: '/logistics/dashboard', label: 'Logistics Dashboard', icon: LayoutDashboard },
    { path: '/logistics/assigned-orders', label: 'Assigned Dispatch Orders', icon: Package },
    { 
      path: '/logistics/assignment', 
      label: 'Vehicle & Driver Assignment', 
      icon: Truck,
    },
    { path: '/logistics/tracking', label: 'Delivery Tracking', icon: MapPin },
    { path: '/logistics/pod', label: 'Proof of Delivery (POD)', icon: FileCheck },
    { path: '/logistics/issues', label: 'Delivery Issues', icon: AlertTriangle },
    { path: '/logistics/reports', label: 'Logistics Reports', icon: BarChart3 },
